function setup() {
  ...
  textSize(30);
  text(`${lastDigit6}`, width / 3, height / 3, width / 9, height / 3);
  text(`${lastDigit5}`, width / 6, height / 3, width / 9, height / 3);
  text(`${lastDigit4}`, width / 2, height / 3, width / 9, height / 3);
  ...
  rect(width / 2, height / 3, width / 9, height / 3)
